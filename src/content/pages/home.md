...
about:
  ...
  paragraphs:
    - >-
      Most organizations we meet have a clear mission and a set of operations
      that quietly contradicts it. That gap is rarely a vision problem. It is
      budgets, payroll, personnel files, filings, and undocumented processes
      that grew up around whoever happened to be doing them at the time.
    - >-
...
process:
  ...
  steps:
    - label: ASSESS
      ...
      body: >-
        The first ninety days are diagnostic. Finances, staffing, compliance,
        systems, facilities, and the gap between the written policy and the
        real practice. We do not prescribe before we understand.
    - label: PRIORITIZE
    ...
    - label: EXECUTE
      ...
      body: >-
        We are. This is not a report you are left to implement alone. We run
        the cleanup, the filings, the rebuild, the hiring, and the transition.
    - label: HAND OFF
      question: What happens when we leave?
      body: >-
        Documented processes, trained staff, and a clear exit. The goal of
        every engagement is to make ourselves unnecessary.
